...
public class CatUnitTest {
	...
	public void testGetRented() {
		// TODO: Fill in
		assertFalse(c.getRented()); // Initially, cat should not be rented
	}
	...
	public void testRentCat() {
		// TODO: Fill in
		c.rentCat();
        assertTrue(c.getRented()); // After renting, cat should be rented
	}
	...
	public void testReturnCat() {
		// TODO: Fill in
		c.rentCat();               // First, rent the cat
        c.returnCat();             // Then return it
        assertFalse(c.getRented()); // Cat should no longer be rented
	}
